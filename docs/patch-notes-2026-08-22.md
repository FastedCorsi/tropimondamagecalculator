...
- Application systématique de `85 EV` dans les six statistiques en Random Battle, y compris lorsque Cobblemon expose seulement une partie de la table EV et laisse certaines valeurs à zéro.
- Application de cette répartition à l'adversaire même lorsqu'il provient d'un Team Preview Random Battle déjà résolu.
